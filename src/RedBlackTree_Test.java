...
class RBTree {
    ...
    /* Function untuk cek apakah tree empty */
    ...
    public void insert(int item) {
        ...
        grand = parent;
        parent = current;
        current = item < current.element ? current.left : current.right; // Check jika dua red children dan memperbaikinya jika benar 
        if (current.left.color == RED && current.right.color == RED) {
            handleReorient(item);
        }
// Insertion gagal jika sudah ada 
        if (current != nullNode) {
            return;
        }
...
// Melakukan perubahan warna current.color = RED; 
...
// Harus rotasi 
    ...
    /* Rotate binary tree node dengan left child */
    ...
    /* Rotate binary tree node dengan right child */
...
public class RedBlackTree_Test {
    public static void main(String[] args) {
        ...
        /* Membuat object RedBlack Tree */ RBTree rbt = new RBTree(Integer.MIN_VALUE);
